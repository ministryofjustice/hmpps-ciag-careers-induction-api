...
class OutboundEventsPublisherTest {
  ...
  @Mock
  private val snsClient: AmazonSNSClient? = null
  ...
  fun shouldEmit_DomainEvent_ForInductionCreationAndUpdate() {
    ...
    Assertions.assertThat(actualPublishedRequest1.messageAttributes["eventType"]!!.dataType).isEqualTo("String")
    Assertions.assertThat(actualPublishedRequest1.messageAttributes["eventType"]!!.stringValue)
    ...
    Assertions.assertThat(actualPublishedRequest2.messageAttributes["eventType"]!!.dataType).isEqualTo("String")
    Assertions.assertThat(actualPublishedRequest2.messageAttributes["eventType"]!!.stringValue)
