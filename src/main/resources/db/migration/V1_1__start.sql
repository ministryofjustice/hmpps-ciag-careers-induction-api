...
alter table  ability_to_work_impact drop constraint  IF EXISTS FKqwdh8an0f7tosgl2djp3eaq6a;
alter table achieved_qualification drop constraint  IF  EXISTS FK9nsis7gdqyadskbcksm7ugskq ;
alter table ciag_profile drop constraint  IF  EXISTS FKl2u6n3u2hvv8hcau0efg212hg ;
alter table ciag_profile drop constraint  IF  EXISTS FKawx49h9mopv8wrlpookycdk7f;
alter table ciag_profile drop constraint  IF  EXISTS FKfgk6llvg4v3dqw5wd17cuklmg;
alter table ciag_profile drop constraint  IF  EXISTS FKkq7lonsvshs4mpjp6hrp5bj6s ;
alter table extra_qualification drop constraint  IF  EXISTS FKrvutj3ivovixy37otbya4no63 ;
alter table particular_work_interests drop constraint  IF  EXISTS FKpc8wtcaga5i9s9n2o0k7kbr4f;
alter table personal_work_interests drop constraint  IF  EXISTS FK3i65cqp2morceh1rpc31tc52a ;
alter table previous_work drop constraint  IF  EXISTS FK2fg36qrgi97gu5ggi4jgshaut ;
alter table prison_education drop constraint  IF  EXISTS FKikvlacla8jpyftbfk7bh41k5u ;
alter table prison_work drop constraint  IF  EXISTS FKhfpgubcyvui0y213gxw8kftao ;
alter table skills_work_interests drop constraint  IF  EXISTS FK29w5gtbsg7bf9wwh4iq6fci2u ;
alter table work_experience drop constraint   IF  EXISTS FK3w4brs7x1okijbwi3tm5yk8gf ;
alter table work_experience_detail drop constraint  IF  EXISTS FKi1fbxy46f7pu36xphmn6sb8c4 ;
alter table work_interests drop constraint  IF  EXISTS FKe4iutmsleo15923jw8cxv6upo ;
alter table reason_to_not_work drop constraint  IF  EXISTS reason_to_not_work_ciag_profile ;
